                ...
                <div class="container ">
                    ...
                    <div class="d-flex justify-content-between mt-5 fw-bold">
                        ...
                        <a href="{{ route('demandes.create') }}"
                            class="px-5 rounded text-white fw-bold py-2 rosette-bg-green d-flex justify-content-center align-items-center">Faire une
                            demande</a>
                    </div>
                                        ...
                                        <tbody>
                                            @foreach ($demandeNonValides as $demandeNonValide)
                                                <tr class="">
                                                    ...
                                                    <td class="py-3 label-color">{{ $demandeNonValide->statut_demande }}
                                                    </td>
                                                    <td class="py-3">
                                        ...
                                        <tbody>
                                            @foreach ($demandeValides as $demandeValide)
                                                <tr class="">
                                                    ...
                                                    <td class="py-3 label-color">{{ $demandeValide->statut_demande }}
                                                    </td>
                                                    <td class="py-3">
