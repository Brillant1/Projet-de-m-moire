                        ...
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link" id="nav-all-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="false">Toutes mes demandes</button>
                                    ...
                                    <div class="">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                    ...
                                                    @forelse($demandeAll as $demandeAll)
                                                        <tr class="">
                                                            <td class="py-3">
                                                                {{ $demandeAll->nom . ' ' . $demandeAll->prenom }}
                                                            </td>
                                                            <td class="py-3">
                                                                {{ $demandeAll->numero_table }}
                                                            </td>
                                                            <td class="py-3">
                                                                {{ $demandeAll->created_at->format('d-m-Y') }} à {{ $demandeAll->created_at->format('H:i:s') }}
                                                            </td>
                                                            <td class="py-3">
                                                                {{ $demandeAll->updated_at->format('d-m-Y') }} à {{ $demandeAll->updated_at->format('H:i:s') }}
                                                                
                                                            </td>
                                                           
                                                            
                                                            <td class="py-3 label-color text-danger">
                                                                {{ $demandeAll->statut_demande }}
                                                            </td>
                                                            <td>
