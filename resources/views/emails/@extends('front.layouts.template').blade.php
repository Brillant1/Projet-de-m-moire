                                                ...
                                                @foreach ($demandes as $demande)
                                                    <tr class="">
                                                        ...
                                                        <td class="py-3 label-color">
                                                            ...
                                                            @if ($demande->statut_payement == 'payer')
                                                                Payer
                                                            @elseif($demande->statut_payement == 'non_payer')
                                                                <a href="{{ url('front.paiement') }}"></a>
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td class="py-3">
                                                            ...
                                                            <a href="{{ route('demandes.edit', ['demande' => $demande->id]) }}"
                                                                title="Editer la demande" class="btn btn-sm text-success ">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                                    height="20" fill="currentColor"
                                                            ...
                                                            <a href="" title="Spprimer la demande">
                                        ...
                                        <tbody>
                                            @if (count($demandeValides))
                                                @foreach ($demandeValides as $demandeValide)
                                                    <tr class="">
                                                        ...
                                                        <td class="py-3">
                                                            ...
                                                            <a title="Consulter le résultat"
                                                                ...
                                                                class="btn btn-sm text-primary" data-bs-toggle="modal"
                                                                data-bs-target="{{ '#showModal' . $demandeValide->id }}"
                                                                title="Consulter">
                                                            ...
                                                            <a
                                                                href="{{ route('demandes.destroy', ['demande' => $demandeValide->id]) }}">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="35"
                                                                    height="35" fill="red" class="bi bi-x"
                                                                    viewBox="0 0 16 16">
                                                                    <path
                                                    ...
                                                    <div class="modal fade container-fluid"
                                                        id="{{ 'showModal' . $demandeValide->id }}" tabindex="-1">
                                                        <div class="modal-dialog" style="max-width: 60%">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title">Récapitulatif de la demande
                                                                ...
                                                                <div
                                                                    class="modal-body d-flex justify-content-center flex-column align-items-center">
                                                                    {{-- tab modal body --}}
                                                                    <img src="{{ 'storage/' . $demandeValide->photo }}"
                                                                        alt="" width="600" height="400"
                                                                        style="object-fit: cover;">
                                                                    <div class="container mt-2">
                                                                        <p
...
<a title="Consulter le résultat" href="{{ route('demandes.show', ['demande' => $demandeValide->id]) }}"
    class="btn btn-sm text-primary" data-bs-toggle="modal"
...
<a href="{{ route('demandes.edit', ['demande' => $demandeValide->id]) }}" title="Editer le résultat"
    class="btn btn-sm text-success ">
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
        class="bi bi-pencil-square" viewBox="0 0 16 16">
        <path
...
<div class="modal fade container-fluid" id="{{ 'showModal' . $demandeValide->id }}" tabindex="-1">
    <div class="modal-dialog" style="max-width: 60%">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Récapitulatif de la demande
            ...
            <div class="modal-body d-flex justify-content-center flex-column align-items-center">
                {{-- tab modal body --}}
                <img src="{{ 'storage/' . $demandeValide->photo }}" alt="" width="600" height="400"
                    style="object-fit: cover;">
                <div class="container mt-2">
...
$message = "Votre demande est soumise avec succès mais mise en attente jusqu'à ce
que vous ne payer les frais de la demande";
...
return view('front.paiement', compact('message', 'nom', 'prenom', 'email', 'contact'));
}
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body">
        ...
        <p class="mt-5 text-center">Aucun message pour
            cette demande</p>
    </div>
</div>
