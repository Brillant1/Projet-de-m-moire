                    ...
                    <form action="{{ route('login')}}" style="width: 95%;" method="POST">  
                        ...
                        <div class="mt-5" style="line-height: 47px;">
                                ...
                                <div class="form-group mt-5">
                                    ...
                                    <input class="form-control border-2 w-100"  style="padding: 15px;"type="password" placeholder="Mot de passe" name="password" id="password" required autocomplete="current-password" >
                                </div>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    ...
                                    @if (Route::has('password.request'))
                                        <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('forgotPassword') }}">
                                ...
                                <div class="form-group mt-4">
                                    <input class="w-100 p-1 rounded text-white fw-bold fs-5 bg-success border-0" type="submit" name="submit" id="submit" value="Connexion">
                                </div>
                                <div class="d-flex justify-content-between mt-4">
