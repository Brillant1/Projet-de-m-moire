...
<div class="pagetitle mt-3 rounded">
    <nav class="rounded">
        <div class="d-flex justify-content-between align-items-center bg-white px-3 py-4 ">
            <div class=" ">
                <h1 style="font-size: 1.2rem">Edition du flash info</h1>
                <ol class="breadcrumb mt-1 mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('flashInfos.index') }}">Dashboard</a></li> &nbsp; /
                    <li class="breadcrumb-item"><a href="{{ route('flashInfos.index') }}">Edition flash info</a></li> &nbsp; /

                    <li class="breadcrumb-item active">Edition du flash info</li>
                    </li>
                </ol>
            </div>
                ...
                <div class="col-12">
                  ...
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <form method="POST" action="{{ route('flashInfos.update', $flash_info->id) }}" class="my-4">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <div class="col-lg-12 col-sm-11">
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                name="date_debut" id="date_debut" value="{{ $flash_info->date_debut }}">
                                            @error('date_debut')
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                name="date_fin" id="date_fin" value="{{ $flash_info->date_fin }}">
                                            @error('date_fin')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12 form-group mt-3">
                                        ...
                                        <textarea class=" @error('contenu') is-invalid @enderror form-control h-50  " name="contenu" id="contenu"
                                            rows="5" value >{{ $flash_info->contenu }}</textarea>
                                        @error('contenu')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
