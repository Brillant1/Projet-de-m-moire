    ...
    <div class="pagetitle mt-3 rounded">
        <nav class="rounded">
            <div class="d-flex justify-content-between align-items-center bg-white px-3 py-4 ">
                <div class=" ">
                    <h1 style="font-size: 1.2rem">Editer un examen</h1>
                    <ol class="breadcrumb mt-1 mb-0">
                        ...
                        <li class="breadcrumb-item active">Edition d'un examen</li>
                        </li>
                    </ol>
                </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card top-selling overflow-auto">
                            <div class="card-body pb-0 MT-3">
                                ...
                                <form method="POST" action="{{ route('examens.update', ['examen' => $examen->id]) }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="reference" class="control-label "> Renseignement du taux des examens de
                                            l'année </label>
                                        <div class="row">
                                            <div class="form-group col p-2">
                                                Examens:
                                        ...
                                        @foreach ($examen->examens as $i => $exam)
                                            <div class="row">
                                                <div class="form-group col p-2">
                                                    <input type="text" name="examens[{{ $i }}][examen]"
                                                        class="form-control" value="{{ $exam['examen'] }}">

                                                </div>
                                                <div class="form-group col p-2">
                                                    <input type="number" name="examens[{{ $i }}][taux]"
                                                        class="form-control" value="{{ $exam['taux'] }}">
                                                </div>
                                            </div>
                                        @endforeach
